...
def main():
    parser = argparse.ArgumentParser(
        description="Side-by-side eval for BoW, LR, and Cardiff Twitter-RoBERTa",
    ...
    parser.add_argument("--cardiff_model_dir", default="data/cardiff_sentiment_model")
    ...
    model_path = Path(args.cardiff_model_dir)
    print(f"Using Cardiff model dir: {model_path.resolve()}")
